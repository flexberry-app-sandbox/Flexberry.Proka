...
namespace IIS.Proka
{
    ...
    public class ДокумПоставки : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proka.Клиенты fКлиенты;
        
        private IIS.Proka.Организация fОрганизация;
        
        private IIS.Proka.DetailArrayOfТЧИнфОЗаказе fТЧИнфОЗаказе;
        ...
        [PropertyStorage(new string[] {
                "Клиенты"})]
        [NotNull()]
        public virtual IIS.Proka.Клиенты Клиенты
        {
            get
            {
                ...
                IIS.Proka.Клиенты result = this.fКлиенты;
        ...
        [PropertyStorage(new string[] {
                "Организация"})]
        [NotNull()]
        public virtual IIS.Proka.Организация Организация
        {
            get
            {
                ...
                IIS.Proka.Организация result = this.fОрганизация;
        ...
        public virtual IIS.Proka.DetailArrayOfТЧИнфОЗаказе ТЧИнфОЗаказе
        {
            get
            {
                ...
                {
                    this.fТЧИнфОЗаказе = new IIS.Proka.DetailArrayOfТЧИнфОЗаказе(this);
                }
                IIS.Proka.DetailArrayOfТЧИнфОЗаказе result = this.fТЧИнфОЗаказе;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДокумПоставкиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокумПоставкиE", typeof(IIS.Proka.ДокумПоставки));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДокумПоставкиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокумПоставкиL", typeof(IIS.Proka.ДокумПоставки));
                }
            }
        }
    }
