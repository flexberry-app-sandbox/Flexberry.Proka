...
namespace IIS.Proka
{
    ...
    public class Товары : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proka.ЕдИзм fЕдИзм;
        ...
        public virtual IIS.Proka.ЕдИзм ЕдИзм
        {
            get
            {
                ...
                IIS.Proka.ЕдИзм result = this.fЕдИзм;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТоварыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыE", typeof(IIS.Proka.Товары));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТоварыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыL", typeof(IIS.Proka.Товары));
                }
            }
        }
    }
