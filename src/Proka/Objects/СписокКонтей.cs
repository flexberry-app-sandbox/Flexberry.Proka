    ...
    public class СписокКонтей : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СписокКонтейE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СписокКонтейE", typeof(IIS.Proka.СписокКонтей));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СписокКонтейL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СписокКонтейL", typeof(IIS.Proka.СписокКонтей));
                }
            }
        }
    }
